...
class PracovniciUklidu extends React.Component{
    showtitle(){
        return 'Pracovnici uklidu pokoju';
    }
    showContent(){
        return<div class="ui three column grid"style={{width:'50%'}} >
            ...
            <div className="column ">Junior</div>
                ...
                <div className="column ">
                    <input value={'13000kc/meisc'} type="text" disabled={true}/>
                </div>
            </div>           
            </div>
    }
...
export default PracovniciUklidu;
